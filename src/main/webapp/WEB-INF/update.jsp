...
<%--<form class="w3-container w3-light-grey" method="post" action="<c:url value='/update'/>">--%>
    ...
    <input class="w3-input w3-border-0" type="number" class="register-input" name="omegaThree" value="${product.omegaThree}" placeholder="${product.omegaThree}" min="0" step="0.1">

    <label>Omega-6 content, mg:</label>
    <input class="w3-input w3-border-0" type="number" class="register-input" name="omegaSix" value="${product.omegaSix}" placeholder="${product.omegaSix}" min="0" step="0.1">
