...
<form class="w3-container w3-light-grey" method="post" action="<c:url value='/update'/>">
    ...
    <input class="w3-input w3-border-0" type="number" class="register-input" name="omegaThree" value="${product.omegaThree}" placeholder="${product.omegaThree}">

    <label>Omega-6 content, mg:</label>
    <input class="w3-input w3-border-0" type="number" class="register-input" name="omegaSix" value="${product.omegaSix}" placeholder="${product.omegaSix}">

    <label>Number of portions (1pt = 28g):</label>
    <input class="w3-input w3-border-0" type="number" class="register-input" name="portions" value="${product.portion}" placeholder="${product.portion}">
