...
import static by.tut.ssmt.controller.util.ControllerConstants.PRODUCT;
...
public class EditFormCommand extends FormsAccessCommand {
    ...
    private static final Logger LOGGER = LogManager.getLogger(FormsAccessCommand.class.getName());
